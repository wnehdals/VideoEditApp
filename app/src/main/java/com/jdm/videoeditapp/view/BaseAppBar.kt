...
class BaseAppBar(
    ...
    fun setLeftButtonDrawable(@DrawableRes resId: Int) {
        ...
        leftButton.setColorFilter(ResourcesCompat.getColor(context.resources, R.color.color_252525, null))
    ...
    fun setRightButtonDrawable(@DrawableRes resId: Int) {
        ...
        rightButton.setColorFilter(ResourcesCompat.getColor(context.resources, R.color.color_252525, null))
